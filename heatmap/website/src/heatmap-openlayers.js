...
OpenLayers.Layer.Heatmap = OpenLayers.Class(OpenLayers.Layer, {
    ...
    setOptions: function(c) {
        if (n() && c) {
            for(var b in c) 
            this.heatmap.set(b, c[b]),
            "gradient" == b? this.heatmap.initColorPalette() :"opacity" == b && this.heatmap.set(b, parseInt(255 / (100 / c[b]), 10));
	...
	destroy: function() {
        // for now, nothing special to do here.wwww
